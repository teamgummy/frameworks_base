...
public class LTEButton extends PowerButton{
    ...
    static {
        OBSERVED_URIS.add(Settings.System.getUriFor(Settings.System.LTE_TOGGLE));
    }
    ...
    protected void updateState() {
        ...
        switch(network) {
            case Phone.NT_MODE_GLOBAL:
                ...
                Settings.System.putInt(resolver, Settings.System.LTE_TOGGLE, 1);
                break;
            case Phone.NT_MODE_CDMA:
                mIcon = R.drawable.stat_lte_off;
                mState = STATE_DISABLED;
                Settings.System.putInt(resolver, Settings.System.LTE_TOGGLE, 0);
                break;
        }
    }
