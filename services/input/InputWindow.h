...
struct InputWindowInfo {
    ...
    enum {
        ...
        TYPE_APPLICATION_ATTACHED_DILOG = FIRST_SUB_WINDOW+3,
        ...
        TYPE_SYSTEM_DILOG      = FIRST_SYSTEM_WINDOW+8,
        TYPE_KEYGUARD_DILOG    = FIRST_SYSTEM_WINDOW+9,
        TYPE_SYSTEM_ERROR       = FIRST_SYSTEM_WINDOW+10,
        TYPE_INPUT_METHOD       = FIRST_SYSTEM_WINDOW+11,
        TYPE_INPUT_METHOD_DILOG= FIRST_SYSTEM_WINDOW+12,
